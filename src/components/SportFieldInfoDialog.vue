  ...
  <Dialog v-model:visible="visible" modal :header="props.sportField.name" :style="{ width: '25rem' }">
    ...
    <div class="flex flex-col gap-y-3">
      <div class="formItem">
        ...
        <Calendar v-model="date" id="date" showIcon iconDisplay="input" dateFormat="dd.mm.yy"/>
      </div>

      <div class="formItem">
        <label for="timeFrom">From</label>
        <Calendar v-model="timeFrom" id="timeFrom" showIcon iconDisplay="input" timeOnly>
      ...
      <div class="formItem">
        ...
        <Calendar v-model="timeTo" id="timeTo" showIcon iconDisplay="input" timeOnly>
          <template #inputicon="{ clickCallback }">
            <InputIcon class="pi pi-clock cursor-pointer" @click="clickCallback"/>
          </template>
        </Calendar>
